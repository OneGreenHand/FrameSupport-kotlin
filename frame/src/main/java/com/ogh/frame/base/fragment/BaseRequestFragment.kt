 ...
 * 带网络请求的fragment
 */
abstract class BaseRequestFragment<T : ViewBinding, P : BasePresenter<*>, B : BaseBean> : BaseFragment<T>(), BaseRequestView<B> {

    lateinit var mPresenter: P
    private var mVaryViewHelperController: VaryViewHelperController? = null

    override fun initCommon() {
        val frameRootView: View? = viewBinding.root.findViewById(R.id.frame_root_view)
