...
object OpenMapUtil {
     ...
     * 是否安装百度地图
     */
    fun isInstallBaiduMap(): Boolean {
        try {
            if (!File("/data/data/" + "com.baidu.BaiduMap").exists()) return false
        } catch (e: Exception) {
            e.printStackTrace()
            return false
        }
     ...
     * 是否安装高德地图
     */
    fun isInstallGaoDeMap(): Boolean {
        try {
            if (!File("/data/data/" + "com.autonavi.minimap").exists()) return false
        } catch (e: Exception) {
            e.printStackTrace()
            return false
        }
     ...
     * 是否安装腾讯地图
     */
    fun isInstallTencentMap(): Boolean {
        try {
            if (!File("/data/data/" + "com.tencent.map").exists()) return false
        } catch (e: Exception) {
            e.printStackTrace()
            return false
        }
     ...
     */
    fun openTencentMap(context: Context, type: String, from: String, fromcoord: String, to: String, tocoord: String, referer: String?) {
        try {
            val sb = StringBuffer()
     ...
     */
    fun openGaoDeMap(context: Context, slat: String, slon: String, sname: String, dlat: String, dlon: String, dname: String, dev: String, t: String) {
        try {
            val sb = StringBuffer()
     ...
     */
    fun openBaiduMap(context: Context, sName: String, sLatlng: String, eName: String, eLatlng: String, mode: String) {
        try {
            val sb = StringBuffer()
